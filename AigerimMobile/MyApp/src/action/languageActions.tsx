...
const getLanguageListSuccess: ActionCreator<LanguageActions> = (
  list: Language[],
) => {
  return {type: GET_Language_LIST_SUCCESS, payload: list};
};
const getLanguageListError: ActionCreator<LanguageActions> = (
  message: string,
) => {
  return {type: GET_Language_LIST_ERROR, payload: message};
};
const setLanguageStatusSuccess: ActionCreator<LanguageActions> = (
  list: Language[],
) => {
  return {type: SET_Language_STATUS_SUCCESS, payload: list};
};
const setLanguageStatusError: ActionCreator<LanguageActions> = (
  message: string,
) => {
  return {type: SET_Language_STATUS_ERROR, payload: message};
};

const addLanguageToListSuccess: ActionCreator<LanguageActions> = (
  list: Language[],
) => {
  return {type: ADD_Language_TO_LIST_SUCCESS, payload: list};
};
const addLanguageToListError: ActionCreator<LanguageActions> = (
  message: string,
) => {
  return {type: ADD_Language_TO_LIST_ERROR, payload: message};
};
const deleteLanguageFromListSuccess: ActionCreator<LanguageActions> = (
  list: Language[],
) => {
  return {type: DELETE_Language_FROM_LIST_SUCCESS, payload: list};
};
const deleteLanguageFromListError: ActionCreator<LanguageActions> = (
  message: string,
) => {
